<div>
      <div>
        <div>
            <h1>
                DOCTOR'S RECORD MANAGEMENT APP
            </h1>
        </div>
        <div>
            <img width="100%" height="10%" src="https://erjyotigoswami9.github.io/assets/hospitalImage-BLaWWliG.png" alt="project-img"/>
        </div>
        <div>
            <h3>
              Tech Stacks
        ...
        <div>
            <a href="https://github.com/erjyotigoswami9/Hospital_Doctor_Record" target="_blank">
            <div>
            ...
            <a href="https://hospital-doctor-record.vercel.app/" target="_blank">
            <div>
